"""
Small GRU seq2seq to prove the model learns the algorithm, not memorization.
hidden_size=16 -> ~1,100 params (24x fewer than training samples).
Curriculum learning + LR scheduler + 500 epochs.
"""
import torch
...
print(f"Training samples (8-bit): 25,908")
print(f"Params/samples ratio: {n_params/25908:.4f}")
print()
...
print(f"RESULT|GRU-S2S-Small|{n_params}|{bit_acc:.2f}|{exact_acc:.2f}|{train_time:.2f}")
